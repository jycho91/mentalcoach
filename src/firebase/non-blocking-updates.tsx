...
/**
 * Awaitable addDoc that emits permission-error for the global listener AND re-throws
 * so the caller can show error UI / defer success toast until write is confirmed.
 */
...
/** Awaitable deleteDoc counterpart to addDocument. */
